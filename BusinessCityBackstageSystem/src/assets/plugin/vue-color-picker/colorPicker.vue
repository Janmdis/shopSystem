...
.m-colorPicker{
  ...
  input{ display: none; }
  .colorBtn{  width: 30px; height: 30px; position: absolute; left: -12px; top: -14px; border-radius: 0 5px 5px 0; }
  ...
  .box.open{ visibility: visible; opacity: 1; z-index: 5;}
  .hd{
