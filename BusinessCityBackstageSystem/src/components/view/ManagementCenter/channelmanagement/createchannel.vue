...
export default {
    ...
    methods:{
        ...
        createercode(row){
            ...
            let url='http://192.168.199.102/customer/resource/qrCode.png?content=http://101.89.175.155:81/invitingGift?recommendedAdminId='+recommendedAdminId+'&recommendedTeamId='+recommendedTeamId;
