...
export default {
    ...
    methods:{
        ...
        createercode(row){
            ...
            let url='http://'+location.hostname+'/invitingGift?recommendedAdminId='+recommendedAdminId+'&recommendedTeamId='+recommendedTeamId;
            let url_code='http://'+location.hostname+'/customer/resource/qrCode.png?content='+url
