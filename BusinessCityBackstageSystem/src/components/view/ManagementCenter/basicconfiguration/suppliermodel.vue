...
export default {
    data () {
        return {
            typeData:[
                {'index':1,'icon':'el-icon-edit','isActive':true,'name':'供应商标签'},
                {'index':2,'icon':'el-icon-menu','isActive':false,'name':'供应商等级'},
                {'index':3,'icon':'el-icon-sold-out','isActive':false,'name':'供应商类型'}
            ],
            urlList:[
                {id:'id',url:'/api/product/label/query',des:'供应商标签',name:'name'},
                {id:'id',url:'/api/product/level/query',des:'供应商等级',name:'levelName'},
                {id:'id',url:'/api/product/category/query',des:'供应商类型',name:'categoryName'}
            ],
            datalist:[]
        }
    },
